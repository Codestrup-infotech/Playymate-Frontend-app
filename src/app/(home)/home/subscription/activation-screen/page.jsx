...
//       // ✅ FIXED: API response is { status, message, data: { subscription_id, plan_name, ... } }
//       // NOT data.data.subscription — it's flat inside data
...
//   // ✅ FIXED: Correct field names from API response
//   // API returns: plan_name, status, price, start_date, end_date,
//   //              billing_cycle, coins_remaining, features, next_renewal
//   const planName = subscription?.plan_name || planKey || "Pro";
//   const status   = subscription?.status    || "ACTIVE";

//   // Coins: prefer URL param (passed at checkout), fallback to API coins_remaining
