...
const slides = [
  ...
  {
    percent: 60,
    title: "Who do you usually play with?",
    options: [
      "Occasionally",
      "Weekly",
      "Regular",
  ...
  {
    percent: 100,
    title: "Do you play this game?",
    options: ["Yes", "Sometimes", "No"],
   
  },
];

export default function GulliDandaPage() {
...
<div className="bg-blue-500 rounded-2xl font-Poppins flex flex-col justify-center items-center text-center h-40  ">
              ...
              <h3 className="text-white text-sm mb-4 font-semibold">🏏 ️GULLI DANDA</h3>
