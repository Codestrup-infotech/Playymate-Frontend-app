...
6. [Core Team APIs](#6-core-team-apis)
7. [Team Slot Sub-Module APIs](#7-team-slot-sub-module-apis)
8. [Team Name Reservation Sub-Module APIs](#8-team-name-reservation-sub-module-apis)
...
```javascript
{
    ...
    status: String,                   // active, pending_payment, invited, suspended, left, removed
...
```javascript
{
    ...
    status: String,                   // PENDING, SUCCESS, FAILED, REFUNDED, PARTIAL_REFUND
...
| `pending_payment` | Membership initiated but not paid     |
