...
const venuesData = {
  ...
  "pro-cricket-ground": {
    ...
    address: "Cricket Stadium, Wakad, Pune, Maharashtra 411057",
    description: "Professional cricket ground with international standard pitch and facilities. Perfect for tournaments, practice sessions, and corporate matches. Our well-maintained ground offers excellent playing conditions.",
    trainer: {
      name: "Cricket Academy Coach",
      image: "/loginAvatars/avatars2.jpg",
    },
    slots: "6 Slots",
    nextSlot: "Tomorrow 9:00 AM",
  },
  "champion-tennis-court": {
    ...
    address: "Tennis Complex, Khadki, Pune 411003",
    description: "Premium hard court tennis facility with floodlights for night play. Professional coaching available for all skill levels.",
    trainer: {
      name: "Tennis Pro Trainer",
      image: "/loginAvatars/avatars3.jpg",
    },
    slots: "2 Slots",
...
// Default venue data for unknown IDs
const defaultVenue = {
  name: "Sports Venue",
  category: "Sports",
  rating: 4.5,
  ...
  address: "Sports Complex, Pune, Maharashtra",
  description: "A great venue for sports activities.",
  trainer: {
...
export default function ListingDetailsPage({ params }) {
  ...
  const venueData = venuesData[id] || defaultVenue;
