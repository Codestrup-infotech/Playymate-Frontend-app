...
export const ONBOARDING_PROGRESS_STATES = [
  ...
  // Additional states from backend (lowercase values)
  { state: 'kyc', percentage: 65, label: 'KYC Verification' },
  { state: 'KYC_INFO', percentage: 65, label: 'KYC Info' },
  { state: 'KYC_DETAILS', percentage: 65, label: 'KYC Details' },
  { state: 'profile-details', percentage: 60, label: 'Profile Details' },
  { state: 'PROFILE_DETAILS', percentage: 60, label: 'Profile Details' },
  { state: 'activity-intent', percentage: 55, label: 'Activity Intent' },
  { state: 'ACTIVITY_INTENT', percentage: 55, label: 'Activity Intent' },
  { state: 'profile-photo', percentage: 50, label: 'Profile Photo' },
  { state: 'PROFILE_PHOTO', percentage: 50, label: 'Profile Photo' },
  { state: 'parent-consent', percentage: 35, label: 'Parent Consent' },
  { state: 'PARENT_CONSENT', percentage: 35, label: 'Parent Consent' },
  { state: 'dob', percentage: 30, label: 'Date of Birth' },
  { state: 'DOB', percentage: 30, label: 'Date of Birth' },
  { state: 'gender', percentage: 20, label: 'Gender' },
  { state: 'GENDER', percentage: 20, label: 'Gender' },
  { state: 'name', percentage: 15, label: 'Name' },
  { state: 'NAME', percentage: 15, label: 'Name' },
  { state: 'NAME_CAPTURE', percentage: 15, label: 'Name Capture' },
  { state: 'BASIC_ACCOUNT', percentage: 15, label: 'Basic Account' },
  { state: 'email', percentage: 10, label: 'Email' },
  { state: 'EMAIL_VERIFICATION', percentage: 10, label: 'Email Verification' },
  { state: 'EMAIL_OTP', percentage: 10, label: 'Email OTP' },
  { state: 'phone', percentage: 5, label: 'Phone' },
  { state: 'PHONE_VERIFICATION', percentage: 5, label: 'Phone Verification' },
  { state: 'PHONE_OTP', percentage: 5, label: 'Phone OTP' },
  { state: 'HOME', percentage: 100, label: 'Home' },
  { state: 'ACTIVE', percentage: 100, label: 'Active' },
  { state: 'DONE', percentage: 100, label: 'Done' },
];
