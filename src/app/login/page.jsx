 ...
 const outerAvatars = [
  ...
  return (
    <div className="lg:px-32 lg:py-12 px-4 min-h-screen bg-black text-white">
      <div className="lg:flex flex flex-col lg:flex-row justify-center lg:space-x-32  lg:space-y-0 lg:border lg:border-dashed border-gray-700 rounded-3xl lg:py-10">
       ...
       <div className="flex flex-col justify-center items-center">
            ...
            <div className=" bg-black flex items-center justify-center">
              <div className="relative lg:w-[400px] h-[400px] flex items-center justify-center  ">

                {/* OUTER DASHED RING - 6 Avatars */}
                <div className="absolute lg:w-[350px] lg:h-[350px] w-[300px] h-[300px] border-2 border-dashed border-gray-600 rounded-full flex items-center justify-center">
                ...
                <div className="absolute lg:w-52 lg:h-52 h-44 w-44 bg-[#262626] rounded-full flex items-center justify-center">
                  ...
                  {/* CENTER WHITE CORE */}
                  <div className="lg:w-36 lg:h-36 h-28 w-28 bg-white rounded-full flex items-center justify-center z-10 shadow-lg">
                    <div className=" rounded-full overflow-hidden">
                      <img
                        src="/loginAvatars/avatars6.jpg"
                        alt="Center"
                        className="lg:w-24 lg:h-24 h-20 w-20 justify-center  items-center"
                      />
                    </div>
                  </div>
                </div>
        ...
        {/* RIGHT SIDE */} 
        <div className="lg:pt-14  flex flex-col justify-center items-center  font-Playfair Display ">
        <div className="text-center lg:max-w-md lg:mb-8 mb-4">
  <h2 className="lg:text-3xl text-2xl font-bold mb-2">
    {screenConfig?.title &&
...
<div className="lg:w-96  "> 
          ...
          <p className="text-sm text-gray-400 lg:mt-6 mt-2 text-center  font-Poppins font-normal">
            Create account?{" "}
            <span
