...
const slides = [
  ...
  },
  {
    percent: 100,
    title: "You prefer?",
    options: ["Solo", "With friends", "In groups"],
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-sm relative overflow-hidden ">
        ...
        {/* Card */}
        <div
          className={`rounded-3xl p-6  shadow-2xl bg-gradient-to-br ${step < 3 ? current.color : "from-black to-black "
            }`}
        >
          {step < 3 ? (
            <>
              ...
              <div className="bg-blue-500 rounded-2xl font-Poppins flex flex-col justify-center items-center text-center h-40  ">
                ...
                <h3 className="text-white text-sm mb-4 font-semibold">💃 DANCE</h3>
            ...
            <div className="flex flex-col items-center justify-center h-80 text-center   ">
              <div className="w-16 h-16 rounded-full  flex items-center justify-center mb-4">
                <span className="text-4xl font-bold  text-white "><img src="/GIF/dancing-couple.gif" alt="" /></span>
              </div>
