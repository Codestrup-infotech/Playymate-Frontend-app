...
// ─── Design tokens (Light theme to match Compare Plans page) ─────────────────
const BG_BASE    = "#FFFFFF";   // page background
const BG_SURFACE = "#F9FAFB";   // cards
const BG_BORDER  = "#E5E7EB";   // borders
const BG_MUTED   = "#F3F4F6";   // muted surfaces

const TEXT_1     = "#111827";   // primary text
const TEXT_2     = "#6B7280";   // secondary text
const TEXT_3     = "#9CA3AF";   // disabled / muted

// Gradients (same as compare page)
...
// ─── Human-readable feature labels (unchanged) ───────────────────────────────
...
// ─── Per-plan display config (unchanged logic, updated colors only) ───────────
const PLAN_CONFIG = {
  free: {
    showBadge: false,
    badgeText: "",
...
// ─── PlanCard — same props, redesigned visuals ────────────────────────────────
